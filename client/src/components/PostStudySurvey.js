          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-100">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-800">Condition Preferences</h3>
              </div>
              ...
              <div className="space-y-4">
                {conditions.map((condition, index) => (
                  <div key={condition.key} className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <h4 className="font-semibold text-gray-800 mb-1">{condition.label}</h4>
              ...
              {errors.ranking && <p className="text-red-500 text-sm mt-4 flex items-center">
              ...
              <div className="mt-6 bg-white rounded-xl p-4 border border-gray-200">
                <h4 className="font-medium text-gray-800 mb-2">Ranking Legend:</h4>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-xs">
                  <div className="flex items-center">
                    <div className="w-6 h-6 bg-emerald-600 rounded mr-2"></div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-100">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-800">Learning Experience</h3>
              </div>
              ...
              {errors.learning && <p className="text-red-500 text-sm mt-4 flex items-center">
                <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                {errors.learning}
            ...
            <div className="bg-blue-50 rounded-2xl p-6 border border-blue-100">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-xl font-bold text-slate-800">AI Assistance Evaluation</h3>
              </div>
              ...
              {errors.usefulness && <p className="text-red-500 text-sm mt-4 flex items-center">
                <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                {errors.usefulness}
            ...
            <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl p-6 border border-orange-100">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-800">Additional Comments</h3>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                ...
                <textarea
                  ...
                  className="w-full p-4 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200 resize-none"
                  rows={4}
                />
                <div className="mt-2 text-right">
                  <span className="text-sm text-gray-500">{responses.feedback.length} characters</span>
                </div>
              </div>
            </div>
