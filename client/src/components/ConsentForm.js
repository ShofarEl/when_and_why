      ...
      <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
        <div className="bg-slate-700 px-8 py-6">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-slate-200">Research Participation Agreement</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-8 space-y-6 max-h-96 overflow-y-auto">
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-slate-100 p-6 rounded-xl border border-slate-200">
              <div className="flex items-center mb-3">
                ...
                <h3 className="font-semibold text-slate-800">Study Purpose</h3>
              </div>
            ...
            <div className="bg-emerald-50 p-6 rounded-xl border border-emerald-200">
              <div className="flex items-center mb-3">
                ...
                <h3 className="font-semibold text-slate-800">Time Commitment</h3>
              </div>
            ...
            <div className="bg-amber-50 p-6 rounded-xl border border-amber-200">
              <div className="flex items-center mb-3">
                ...
                <h3 className="font-semibold text-slate-800">AI Interaction</h3>
              </div>
              <p className="text-sm text-slate-600">
          ...
          <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
            <h3 className="font-semibold text-slate-800 mb-3">Your Rights</h3>
        ...
        <div className="bg-slate-50 p-6 border-t border-slate-200">
          <div className="flex items-start space-x-4">
            <input
              ...
              className="mt-1 h-5 w-5 text-slate-600 focus:ring-slate-500 border-slate-300 rounded"
            />
            <label htmlFor="consent-checkbox" className="text-sm text-slate-700 cursor-pointer">
