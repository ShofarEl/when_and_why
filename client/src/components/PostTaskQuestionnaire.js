        ...
        <div className="bg-gradient-to-r from-emerald-600 to-teal-600 px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white">Task {taskNumber} Feedback</h2>
                <p className="text-emerald-100">How was your experience with this condition?</p>
              </div>
            </div>
        ...
        <div className="p-8">
          <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-xl p-6 mb-8 border border-emerald-100">
            <div className="flex items-center mb-2">
              ...
              <h3 className="font-semibold text-gray-800">Condition Details</h3>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-100">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-800">Your Experience</h3>
              </div>
              ...
              {errors.agency && <p className="text-red-500 text-sm mt-4 flex items-center">
            ...
            <div className="bg-blue-50 rounded-2xl p-6 border border-blue-100">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-xl font-bold text-slate-800">AI Dependence</h3>
              </div>
              ...
              {errors.dependence && <p className="text-red-500 text-sm mt-4 flex items-center">
                <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                {errors.dependence}
            ...
            <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl p-6 border border-orange-100">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-800">Task Difficulty</h3>
              </div>
              <p className="text-sm text-gray-600 mb-6">
              ...
              {errors.cognitiveLoad && <p className="text-red-500 text-sm mt-4 flex items-center">
                <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
            ...
            <div className="flex justify-center pt-4">
              <button
                type="submit"
                className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-semibold rounded-xl hover:from-emerald-700 hover:to-teal-700 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl"
              >
