          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-200">
              <div className="text-center mb-8">
                ...
                <h2 className="text-3xl font-bold text-slate-800 mb-4">Welcome to the Study</h2>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <div className="bg-slate-50 rounded-xl p-6 shadow-sm border border-slate-100">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-slate-800">Creative Tasks</h3>
                  </div>
                ...
                <div className="bg-slate-50 rounded-xl p-6 shadow-sm border border-slate-100">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-slate-800">AI Assistance</h3>
                  </div>
                  <p className="text-slate-600 text-sm">
                ...
                <div className="bg-slate-50 rounded-xl p-6 shadow-sm border border-slate-100">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-slate-800">Reflection</h3>
                  </div>
                  <p className="text-slate-600 text-sm">
                ...
                <div className="bg-slate-50 rounded-xl p-6 shadow-sm border border-slate-100">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-slate-800">Your Goal</h3>
                  </div>
                  <p className="text-slate-600 text-sm">
              ...
              <div className="text-center">
                <button 
                  onClick={nextPhase}
                  className="inline-flex items-center px-8 py-4 bg-slate-600 text-white font-semibold rounded-xl hover:bg-slate-700 transition-all duration-200 shadow-lg hover:shadow-xl"
                >
        ...
        return (
          <div className="max-w-3xl mx-auto text-center">
            <div className="bg-white rounded-2xl p-12 shadow-lg border border-slate-200">
              ...
              <h2 className="text-4xl font-bold text-slate-800 mb-4">Study Complete!</h2>
              <p className="text-xl text-slate-600 mb-6">
                Thank you for your valuable contribution to AI-assisted creativity research
              </p>
              <div className="bg-slate-50 rounded-xl p-6 mb-8 shadow-sm border border-slate-100">
                <p className="text-sm text-slate-500 mb-2">Your anonymous participant ID:</p>
                <p className="text-2xl font-mono font-bold text-slate-800">{participantId}</p>
              </div>
