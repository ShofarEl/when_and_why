          ...
          <div className="max-w-5xl mx-auto px-2 sm:px-4">
            <div className="bg-white rounded-xl md:rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg border border-slate-200">
              <div className="text-center mb-6 md:mb-8">
                <div className="inline-flex items-center justify-center w-12 h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 bg-white rounded-full mb-3 md:mb-4 shadow-lg border border-slate-200">
                  <img 
                    src="/logo.png" 
                    alt="iNSIGHT AI Logo" 
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="container mx-auto px-2 sm:px-4 py-4 md:py-6 lg:py-8">
        <header className="text-center mb-6 md:mb-8 lg:mb-12">
          ...
          <p className="text-xs md:text-sm text-slate-500 max-w-2xl mx-auto px-4 mt-1">
